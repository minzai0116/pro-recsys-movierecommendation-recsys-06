...
from src.data.loaders.atomic_loader import load_atomic_files
from src.data.pipelines.registry import register_pipeline

@register_pipeline("seq_topn_load_atomic")
class SeqTopNMLV1Pipeline(DataPipelineBase):
    name = "seq_topn_load_atomic"
    ...
    def prepare_data(
        ...
        # 컬럼명 변경
        ratings.columns = [user_col, item_col, time_col]
